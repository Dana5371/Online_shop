# Generated by Django 4.0.4 on 2022-06-16 04:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='Name', max_length=155, verbose_name='Имя')),
                ('last_name', models.CharField(default='LastName', max_length=155, verbose_name='Фамилия')),
                ...
                ('country', models.CharField(default='Kyrgyzstan', max_length=200, verbose_name='Страна')),
                ('city', models.CharField(default='Bishkek', max_length=155, verbose_name='Город')),
                ('date_of_order', models.DateTimeField(default=datetime.datetime.now, verbose_name='добавить время')),
