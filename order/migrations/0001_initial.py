    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity_of_size', models.PositiveIntegerField(default=0, verbose_name='Кол-во линеек')),
                ('quantity_of_products', models.PositiveIntegerField(default=0, verbose_name='Кол-во товаров')),
            ],
            options={
