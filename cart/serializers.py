...
class ShopCartSerializer(serializers.Serializer):
    title = serializers.CharField(source='color.products.title', read_only=True)
    collection = serializers.CharField(source='color.products.collection', read_only=True)
    old_price = serializers.CharField(source='color.products.old_price', read_only=True)
    new_price = serializers.CharField(source='color.products.new_price', read_only=True)
    discount = serializers.CharField(source='color.products.discount', read_only=True)
    size = serializers.CharField(source='color.products.size', read_only=True)
    line = serializers.CharField(source='color.products.line_of_size', read_only=True)
    ...
    color = serializers.PrimaryKeyRelatedField(required=True,
